// ── Server Platforms ──
export type PlatformId = 'gb300-nvl72' | 'gb300-nvl36x2' | 'dgx-b300' | 'dgx-b200' | 'gb200-nvl72' | 'hgx-b300' | 'hgx-b200' | 'xeon-6' | 'epyc-9005';
...
// ── Coolants ──
export type CoolantId = 'pg25' | 'pg30' | 'di-water' | 'pg50';
